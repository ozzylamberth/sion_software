...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'Valoracion por Nutricion Consulta externa', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(32,5, utf8_encode($row['freg_nutrice_sm'].' | '.$row['hreg_nutrice_sm']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      ...
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['val_nutri']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Diagnostico Nutricional:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['dxnutri']),1,'L');
...
i.descripuedad,
j.nom_eps,
k.id_val_nutri,freg_nutrice_sm, hreg_nutrice_sm, motivonutri,val_nutri,dxnutri,plan_nutri,recomendaciones,estado_nutrice_sm,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join nutrice_sm k on (k.id_adm_hosp=b.id_adm_hosp)
