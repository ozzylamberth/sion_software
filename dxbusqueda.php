      ...
      <table class="table table-bordered">
        ...
        <?php
          ...
          $sql_dx="SELECT ddxp,tdxp FROM evolucion_medica a inner join user b on a.id_user=b.id_user
           WHERE a.id_adm_hosp=$adm and b.id_perfil in (3,4) ORDER BY id_evomed DESC limit 1";
           //echo $sql_dx;
        ...
        <tr>
          <?php
            $adm=$_REQUEST['idadmhosp'];
            $sql_dx1="SELECT max(a.ddx1) dx1,max(a.tdx1) tdx1 FROM evolucion_medica a inner join user b on a.id_user=b.id_user
             WHERE a.id_adm_hosp=$adm and b.id_perfil in (3,4) ORDER BY id_evomed DESC limit 1";
             //echo $sql_dx1;
             if ($tabla_dx1=$bd1->sub_tuplas($sql_dx1)){
               foreach ($tabla_dx1 as $fila_dx1) {
                 ...
                 <td class="">
                   ...
                   <input type="text" name="dx1" class="form-control" value="<?php echo $fila_dx1['dx1'] ?>" id="buscardx1">
                 </td>
                 <td class="">
                   <label for="">Tipo diagnostico:</label>
