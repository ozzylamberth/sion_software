...
where b.tipo_servicio='Rehabilitacion'  and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imfisio_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
...
where b.tipo_servicio='Rehabilitacion'  and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imfono_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
...
where b.tipo_servicio='Rehabilitacion'  and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imto_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
...
where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_impsico_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
UNION
...
where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imequino_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
UNION
...
where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imhidro_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
UNION
...
where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_impsicocog_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
UNION
...
where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imtap_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
UNION
...
where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_immusico_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
UNION

select
a.doc_pac,a.nom1,a.nom2,a.ape1,a.ape2,descricie ,a.edad,
b.id_adm_hosp  id_adm_hosp,'ACOMPANAMIENTO SOMBRA' tipo_servicio,
e.freg_imsombra_reh fecha_Informe,e.objetivo_imsombra_reh Objetivo,e.actrealizada_imsombra_reh Actividades_realizadas,e.logros_imsombra_reh Logors,e.plant_imsombra_reh Plan_tratamiensombra,e.id_user usuario,
f.nombre terapeuta,f.firma firma_user,
g.nom_eps nombre_eps,
h.nom_sedes sede
...
pacientes a inner join adm_hospitalario b on (b.id_paciente = a.id_paciente)
		    inner join im_sombra_reh e on (e.id_adm_hosp = b.id_adm_hosp)
            inner join user f on (e.id_user = f.id_user)
            inner join eps g on (b.id_eps = g.id_eps)
            inner join sedes_ips h on (b.id_sedes_ips = h.id_sedes_ips)

where b.tipo_servicio='Rehabilitacion'  and  b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_imsombra_reh BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
