      ...
      <section class="col-md-6 ">
        <article class="col-md-12">
          ...
          <input type="hidden" name="aut" value="<?php echo $_GET["formato"] ;?>" class="form-control" <?php echo $atributo3;?> >
					<input type="hidden" name="vigencia1" value="<?php echo $_GET["v1"] ;?>" class="form-control" <?php echo $atributo3;?> >
					<input type="hidden" name="vigencia2" value="<?php echo $_GET["v2"] ;?>" class="form-control" <?php echo $atributo3;?> >
        </article>
        <article class="col-md-12">

          <label for="">Hora de Atención:</label>
          <input type="time" name="hnota" value="<?php echo $date1 ;?>" class="form-control" <?php echo $atributo3;?>>
          <input type="hidden" name="turno" value="<?php echo $_REQUEST['turno'] ;?>" class="form-control">
