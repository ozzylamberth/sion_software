	...
	<section class="panel-header">
	  ...
	  ?>
		...
		<div id="tabs" class="panel panel-default">
		    ...
		    <li><a href="#tabs-3">Aspecto Físico</a></li>
				<li><a href="#tabs-4">Medidas Especiales</a></li>
				<li><a href="#tabs-5">Área Funcional</a></li>
				<li><a href="#tabs-6">Pronostico y Objetivo</a></li>
        <li><a href="#tabs-7">Plan de tratamiento</a></li>
		  </ul>
        ...
        <article class="col-xs-10">
			...
			<div id="tabs-3" class="panel-body">
				<article class="col-xs-10">
					<label for="">AMPLITUD MUSCULAR:</label>
					<textarea class="form-control" name="amplitud_muscular" rows="5" id="comment" required ></textarea>
				</article>
				<article class="col-xs-10">
					<label for="">FUERZA MUSCULAR :</label>
					<textarea class="form-control" name="fuerza_muscular" rows="5" id="comment" required ></textarea>
				</article>
				<article class="col-xs-10">
					<label for="">RESISTENCIA:</label>
					<textarea class="form-control" name="resistencia" rows="5" id="comment" required ></textarea>
				</article>
			</div>
			<div id="tabs-4" class="panel-body">
				<label for="">MEDIDAS ESPECIALES :</label>
				<textarea class="form-control" name="medidas_especiales" rows="5" id="comment" required ></textarea>
			</div>
			<div id="tabs-5" class="panel-body">
				<article class="col-xs-10">
					<label for="">HABILIDADES MOTORAS SUPERIORES:</label>
					<textarea class="form-control" name="hab_superiores" rows="5" id="comment" required ></textarea>
				</article>
				<article class="col-xs-10">
					<label for="">HABILIDADES MOTORAS INFERIORES:</label>
					<textarea class="form-control" name="hab_inferiores" rows="5" id="comment" required ></textarea>
				</article>
        <article class="col-xs-10">
					<label for="">HABILIDADES MOTORAS INTEGRADAS:</label>
					<textarea class="form-control" name="hab_integradas" rows="5" id="comment" required ></textarea>
				</article>
			</div>
