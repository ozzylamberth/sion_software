<form action="<?php echo PROGRAMA.'?doc='.$doc.'&servicio='.$servicio.'&buscar=Buscar&opcion='.$option;?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
 <section class="panel panel-default">
     ...
     <article class="col-md-4">
       ...
       <input type="hidden" name="id_infoacu" value="<?php echo $fila['id_infoacu'] ?>" class="form-control" required="">
     </article>
     <article class="col-md-6">
       <label for="">Dirección:</label>
       <input type="text" name="direccion" value="<?php echo $fila['dir_acu'] ?>" class="form-control" required="">
     </article>
     <article class="col-md-2">
       <label for="">Teléfono:</label>
       <input type="tel" name="telefono" value="<?php echo $fila['tel_acu'] ?>" class="form-control" required="">
     </article>
     <article class="col-md-4">
   ...
   <section class="panel-body">
     <article class="col-md-12">
       ...
       <textarea name="obs_actualiza" class="form-control" rows="5"></textarea>
     </article>
   </section>
 </section>
