...
e.id_evofisio_ce id, e.freg_evofisio_ce fecha_evo,e.hreg_evofisio_ce hora_evo,e.evolucionfisio_ce evolucion,e.id_user id_user,
f.nombre nombre_usuario, f.firma firmat,
g.nom_eps eps,
h.nom_sedes sedes

from pacientes a right join adm_hospitalario b on (b.id_paciente = a.id_paciente)
right join evo_fisio_ce e on (e.id_adm_hosp = b.id_adm_hosp)
...
where b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evofisio_ce BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
