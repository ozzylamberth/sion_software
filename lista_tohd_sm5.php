...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO tohd_sm ( id_adm_hosp, id_user, freg_toce_sm,hreg_toce_sm,evaluacion_to,concepto_to,dx_to,plan_intervencion,recomendaciones_to,estado_toce_sm) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evaluacion_ocupacional"]."',
				'".$_POST["concepto_ocupacional"]."','".$_POST["dx_ocupacional"]."','".$_POST["plan_intervencion"]."','".$_POST["recomendaciones"]."','Realizada')";
				$subtitulo="Valoracion Hospital dia";
				$subtitulo1="Adicionado";
				$subtitulo2="Terapia Ocupacional";
			break;
			case 'EVO':
				$sql="INSERT INTO evo_tohd_sm (id_adm_hosp, id_user, freg_evoto, hreg_evoto, evolucion_to, estado_evoto, resp_evoto) VALUES
...
if (isset($_GET["mante"])){					///nivel 2
	switch ($_GET["mante"]) {
		...
		where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/val_tohd_sm.php';
			...
			where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
				...
				$date=date('Y-m-d');
				$date1=date('H:i');
				$form1='formularios/evo_tohd_sm.php';
				$subtitulo='Evolucion';
				break;
...
<section class="panel panel-default">
	<section class="panel-heading"><h3>Hospital Dia Terapia Ocupacional (Salud Mental)</h3></section>
