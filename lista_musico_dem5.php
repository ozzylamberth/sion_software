...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_musico_dem (id_adm_hosp, id_user, freg_evomusico, hreg_evomusico, evolucionmusico, estado_evomusico) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evoto"]."','Realizada')";
				$subtitulo="Evolución Musicoterapia";
			...
			if ($_SESSION["AUT"]["especialidad"]=='ADMINISTRATIVO') {
				...
				$subtitulo="Informe Mensual Musicoterapia";
				$subtitulo1="Adicionado";
				$subtitulo2="Demencias";
			...
			if ($_SESSION["AUT"]["especialidad"]=='ADMINISTRATIVO') {
				$sql="";
				$msg='LA ESPECIELIDAD DE SU PERFIL NO LE PERMITE REALIZAR REGISTROS ASISTENCIALES';
				$subtitulo="Plan Trimestral Individual Musicoterapia";
				$subtitulo1="Adicionado";
				$subtitulo2="Demencias";
...
<section class="panel-heading"><h4>Musicoterapia INDE Programa Demencias</h4></section>
