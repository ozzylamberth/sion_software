...
<section class="panel panel-default">
	<section class="panel-heading"><h4>Reporteador Auditoria externa Famisanar EPS</h4></section>
	<section class="panel-body">
		...
		<?php
			...
			$tr1='<td colspan="4" class="text-center"><strong>INTRHOSPITALARIO</strong></td>
			<td colspan="6" class="text-center"><strong>DATOS PACIENTE</strong></td>
			<td colspan="4" class="text-center"><strong>EGRESO</strong></td>';
			$tr2='<td colspan="4" class="text-center"><strong>PSIQUIATRIA</strong></td>
			<td colspan="7" class="text-center"><strong>DATOS PACIENTE</strong></td>
			<td  colspan="2" class="text-center"><strong>INTERDISCIPLINARIOS</strong></td>';
			$tr11='
			...
			<th id="th-estilo4">Incapacidades</th>
			<th id="th-estilo4">Ayudas DX</th>
			<th id="th-estilo4">Epicrisis</th>';
			$tr22='
			<th id="th-estilo4">HC Primera vez</th>
			<th id="th-estilo4">Evolucion Control</th>
			<th id="th-estilo4">Ayudas DX</th>
			<th id="th-estilo4">Incapacidades</th>
		...
		<table class="table table-bordered table-responsive">
			...
			WHERE a.id_eps in (12) and tipo_servicio='$tserv' Group by id_adm_hosp order by a.fingreso_hosp DESC";
			...
			if ($tabla=$bd1->sub_tuplas($sql)){
			  ...
			  foreach ($tabla as $fila ) {
					if ($tserv=='Hospitalario') {
					    ...
					    $doc=$fila["doc_pac"];
					    $cie=$fila["descricie"];
							echo'<th class="text-center  alert-warning" ><a href="rpt_hcingreso.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&cie='.$cie.'&eps='.$eps.'&doc='.$doc.'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
					    echo'<th class="text-center  alert-warning" ><a href="rpt1.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&cie='.$cie.'&eps='.$eps.'&doc='.$doc.'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span> </button></a></th>';
					    echo'<th class="text-center alert alert-warning" ><a href="rpt_ordenhosp.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&cie='.$cie.'&eps='.$eps.'&doc='.$doc.'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
					    echo'<td class="text-center  alert-warning"><strong>'.$fila["tdoc_pac"].': '.$fila["doc_pac"].' -- AMD:'.$fila["id_adm_hosp"].'</strong></td>';
					    ...
					    echo'<td class="text-center  alert-warning">'.$fila["fingreso_hosp"].' | '.$fila["hingreso_hosp"].'</td>';
							if ($fila["fegreso_hosp"]=='') {
								echo'<td class="text-center   alert-warning"><strong>SIN EGRESO</strong></td>';
							}else {
					    ...
					    echo'<td class="text-center  alert-warning">'.$fila["nom_sedes"].'</td>';
							...
							echo'<th class="text-center  alert-warning" ><span class="fa fa-ban"></span></button></a></th>';
					    echo'<th class="text-center  alert-warning" ><span class="fa fa-ban"></span> </button></a></th>';
					    echo'<th class="text-center  alert-warning" ><span class="fa fa-ban"></span></button></a></th>';
					    echo "</tr>\n";
						}else {
					    ...
					    echo'<td class="text-center  alert-warning">'.$fila["nom_sedes"].'</td>';
							echo'<td class="text-center  alert-warning">'.$fila["nom_eps"].'</td>';
							echo'<td class="text-center  alert-warning">'.$fila["tipo_servicio"].'</td>';
							echo'<th class="text-center alert-warning" ><a href="rpt_incapa.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&edad='.$edad.'&cie='.$cie.'&eps='.$eps.'"><button type="button" class="btn btn-success sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
					    echo'<th class="text-center  alert-warning" ><a href="rpt_ordenmedica.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&edad='.$edad.'&cie='.$cie.'&eps='.$eps.'"><button type="button" class="btn btn-success sombra_movil " ><span class="fa fa-file-pdf-o"></span> </button></a></th>';
					    echo'<th class="text-center alert-warning" ><a href="rptepicrisis.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&edad='.$edad.'&cie='.$cie.'&eps='.$eps.'"><button type="button" class="btn btn-success sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
					    echo "</tr>\n";
						}
				    ...
				    $doc=$fila["doc_pac"];
				    $cie=$fila["descricie"];
						echo'<th class="text-center alert-info"><a href="rpt_hcCESM.php?idadmhosp='.$fila["id_adm_hosp"].'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
						echo'<th class="text-center alert-info"><a href="rptceSM.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$_POST["fecha1"].'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
						echo'<th class="text-center  alert-warning" ><a href="rpt_ordenmedica.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&edad='.$edad.'&cie='.$cie.'&eps='.$eps.'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span> </button></a></th>';
						echo'<th class="text-center alert-warning" ><a href="rpt_incapa.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$f1.'&f2='.$f2.'&nom='.$fila["nom1"].' '.$fila["nom2"].' '.$fila["ape1"].' '.$fila["ape2"].'&edad='.$edad.'&cie='.$cie.'&eps='.$eps.'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
				    echo'<td class="text-center  alert-info"><strong>'.$fila["tdoc_pac"].': '.$fila["doc_pac"].' -- AMD:'.$fila["id_adm_hosp"].'</strong></td>';
				    ...
				    echo'<td class="text-center  alert-info">'.$fila["fingreso_hosp"].' | '.$fila["hingreso_hosp"].'</td>';
						if ($fila["fegreso_hosp"]=='') {
							echo'<td class="text-center   alert-info"><strong>SIN EGRESO</strong></td>';
						}else {
				    ...
				    echo'<td class="text-center  alert-info">'.$fila["nom_sedes"].'</td>';
						...
						echo'<th class="text-center alert-info"><a href="rpt_valpsico_sm.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$_POST["fecha1"].'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
						echo'<th class="text-center alert-info"><a href="rpt_valnutri_sm.php?idadmhosp='.$fila["id_adm_hosp"].'&f1='.$_POST["fecha1"].'"><button type="button" class="btn btn-primary sombra_movil " ><span class="fa fa-file-pdf-o"></span></button></a></th>';
				    echo "</tr>\n";
					}
			  }
			}
