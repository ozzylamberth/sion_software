...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'FORMATO ESTANDARIZADO DE REFERENCIA DE PACIENTES', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
        $this->SetFont('helvetica', '', 9);
        $this->Cell(30, 5, 'FR-APLA-06', 1, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(30, 5, 'Version:01', 1, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(120, 5, 'Fecha de Emision: 2016-09-26', 1, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln();
    }
	...
	public function ColoredTable($header,$data) {
      ...
      $this->Cell(180,5,'INFORMACIÓN DEL PRESTADOR',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,5,'CLINICA EMMANUEL IPS',1,0,'C',0);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(26,5,'Dirección:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(84,5, utf8_encode($row['dir_sedes']),1,0,'C');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(15,5,'Teléfono:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(55,5,'743-3693',1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(26,5,'SEDE:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(84,5,utf8_encode($row['nom_sedes']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 12);
      $this->Cell(180,5,'DATOS GENERALES DEL PACIENTE',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(20,5, utf8_encode($row['descritusuario']),1,0,'C');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(17,5,'T.Afiliacion:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(20,5, utf8_encode($row['descriafiliado']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      ...
      $this->Cell(20,5,'Código EPS:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(64,5, utf8_encode($row['cod_eps']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 12);
      $this->Cell(180,5,'DATOS DE LA PERSONA RESPONSABLE',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->Cell(180,5, utf8_encode($row['nombre_acu']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(26,5,'Dirección:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      ...
      $this->Cell(15,5,'Teléfono:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(55,5,utf8_encode($row['tel_acu']),1,0,'C');
  		$this->Ln(10);
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(22,5,'Fecha Registro:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(32,5, utf8_encode($row['freg']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(10,5,'CUPS:',1,0,'C',1);
      $this->SetFont('helvetica', 'B',8);
      $this->Cell(10,5, utf8_encode($row['cups']),1,0,'C');
      $this->SetFont('helvetica', '',8);
      $this->Cell(160,5, utf8_encode($row['descricups']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,5,'JUSTIFICACIÓN DE LA REMISIÓN:',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', '',9);
      $this->multiCell(180,0, utf8_encode($row['justificacion']),1,'J');
...
i.descripuedad,
j.nom_eps,cod_eps,
n.dir_sedes,nom_sedes,
k.id_remision, freg, cups, descricups, justificacion, estado_remision,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join sedes_ips n on (n.id_sedes_ips=b.id_sedes_ips)
      left join remision k on (k.id_adm_hosp=b.id_adm_hosp)
      left join info_acudiente m on (m.id_adm_hosp=b.id_adm_hosp)
      left join user l on (l.id_user=k.id_user)
where b.id_adm_hosp ='".$_GET["idadmhosp"]."'
ORDER BY k.id_remision DESC LIMIT 1";
//echo $sql;
$rs = mysql_query($sql);
