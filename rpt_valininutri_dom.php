...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'Valoracion por Nutricion (Servicios Domiciliarios)', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(32,5, utf8_encode($row['freg_nutri'].' | '.$row['hreg_nutri']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'Valoracion inicial Nutricion',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Motivo nutricional:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['motivonutri']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Valoracion nutricional:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['val_nutricional']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Diagnostico Nutricional:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['dx_nutricional']),1,'L');

      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Plan de Manejo:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['plan_nutricional']),1,'L');
...
i.descripuedad,
j.nom_eps,
k.id_val_nutri,  freg_nutri, hreg_nutri, motivo_nutri, val_nutricional, dx_nutricional, plan_nutricional, estado_nutri,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join val_nutri_dom k on (k.id_adm_hosp=b.id_adm_hosp)
