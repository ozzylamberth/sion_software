...
class MYPDF extends TCPDF {
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('','',9);
      $this->Ln();
      $this->MultiCell(180,0, utf8_encode($row['fecha_evo'] .' | '.$row['hora_evo']. ' Profesional: ' .$row['nombre_usuario']),1,0,'L');
      $this->SetFont('','',7);
      $this->multiCell(180,0, utf8_encode($row['evolucion']),1,'L');
      $this->cell(35,20,$this->image($row['firmat'] , $this->GetX(), $this->GetY(),35,20),0,'J');
		}
