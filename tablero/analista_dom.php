<section class="panel panel-default">
  <section class="panel-heading">
    ...
    <h3>Aqui puedes realizar Consulta de profesionales activos</h3>
  </section>
  <section class="panel-body">
    ...
    <article class="col-md-3 col-sm-6">
      <button data-toggle="collapse" class="btn btn-info btn-lg text-center" data-target="#lista_profesionales"><span class="fa fa-user-md fa-4x"></span><br> Haga Click AQUI para ver<br>Profesionales ACTIVOS</button>
    </article>
    <article class="col-md-3 col-sm-6">
      <p><h3>Recuerde que esta realizando el filtro entre:</h3></p>
      <p><strong>Fecha 1:</strong> <?php echo $_REQUEST['f1'] ?></p>
      <p><strong>Fecha 2:</strong> <?php echo $_REQUEST['f2'] ?></p>
    </article>
  </section>
  <section class="panel-body">
