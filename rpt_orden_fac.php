...
class MYPDF extends TCPDF {
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(30,0, utf8_encode($f1),1,0,'C');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(20,0,'Tipo atención:',1,0,'C',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(25,0, utf8_encode('Hospitalario'),1,0,'C');
      $this->SetFont('helvetica', 'B',8);
      $this->Cell(83,0,'Procedimientos ordenados:',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', '',7);
      $this->MultiCell(90, 15,utf8_encode('S12710 -- INTERNACION EN UNIDAD DE SALUD MENTAL COMPLEJIDAD MEDIANA	') .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(90, 15,utf8_encode('Solicitud de hospitalición en el periodo '.$f1.' - '.$f2 ) .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->Ln();
      $this->SetFont('helvetica', '',7);
...
where  b.id_adm_hosp='".$adm."' and l.id_perfil=3";
//echo $sql;
$rs = mysql_query($sql);
