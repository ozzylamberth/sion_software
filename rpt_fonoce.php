...
$sql="SELECT a.doc_pac,a.nom1,a.nom2,a.ape1,a.ape2 paciente, b.id_adm_hosp id_adm_hosp,'FONOAUDIOLOGIA' tipo_terapia,
        e.id_evofono_ce id, e.freg_evofono_ce fecha_evo,e.hreg_evofono_ce hora_evo,e.evolucionfono_ce evolucion,e.id_user id_user,
        f.nombre nombre_usuario, f.firma firmat,
        g.nom_eps eps,
        h.nom_sedes sedes

FROM pacientes a right join adm_hospitalario b on (b.id_paciente = a.id_paciente)
                 right join evo_fono_ce e on (e.id_adm_hosp = b.id_adm_hosp)
...
WHERE b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evofono_ce BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
