...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO nutrice_sm ( id_adm_hosp, id_user, freg_nutrice_sm,hreg_nutrice_sm,motivonutri,val_nutri,dxnutri,plan_nutri,recomendaciones,estado_nutrice_sm) VALUES
...
<table class="table table-bordered">
	<tr>
		...
		<th id="th-estilo4">Valoracion Nutrición</th>
