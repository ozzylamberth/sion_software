	...
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				...
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evaluacion_ocupacional"]."','".$_POST["concepto_ocupacional"]."','".$_POST["dx_ocupacional"]."','".$_POST["plan_intervencion"]."','".$_POST["recomendaciones"]."','Realizada')";
				$subtitulo="EVolucion";
...
if (isset($_GET["mante"])){					///nivel 2
	switch ($_GET["mante"]) {
		...
		where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$doc=$_REQUEST['doc'];
			$form1='formularios/val_toce_sm.php';
...
<table class="table table-bordered">
	<tr>
		...
		<th id="th-estilo4">Valoracion Terapia ocupacional</th>
	</tr>
	...
	$sql="SELECT p.id_paciente,tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,fotopac,a.id_adm_hosp,fingreso_hosp,hingreso_hosp,s.nom_sedes
				...
				WHERE p.doc_pac='".$doc."' and a.estado_adm_hosp='Activo' and tipo_servicio='Consulta Externa SM'";
	...
	if ($tabla=$bd1->sub_tuplas($sql)){
		...
		foreach ($tabla as $fila ) {
			...
			echo'<th class="text-center"><a href="'.PROGRAMA.'?opcion='.$_REQUEST["opcion"].'&mante=VI&idadmhosp='.$fila["id_adm_hosp"].'&doc='.$fila["doc_pac"].'"><button type="button" class="btn btn-primary sombra_movil" ><span class="fa fa-plus-circle"></span></button></a></th>';
			echo "</tr>\n";
		}
	}
