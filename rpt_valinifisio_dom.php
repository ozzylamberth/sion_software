...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'VALORACION INICIAL FISIOTERAPIA (Servicios domiciliarios)', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(32,5, utf8_encode($row['freg_fisio_dom'].' | '.$row['hreg_fisio_dom']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      ...
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Apoyos Diagnosticos:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      ...
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['dolor']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Piel y faneras:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      ...
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Funcion osteomuscular p:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      ...
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'PRONOSTICO FISIOTERAPEUTICO',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['pron_fisioterapeutico']),1,'L');
      $this->SetFont('helvetica', 'B',9);
      $this->Cell(180,0,'OBJETIVO TERAPEUTICO',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
...
i.descripuedad,
j.nom_eps,
k.id_fisio_dom, freg_fisio_dom, hreg_fisio_dom, motivo_consulta, ant_patologico, ant_traumaticos, ant_toxicologico, ant_quirurgico, ant_farmacologico, ant_ocupacional, ant_familiar, apoyo_dx, dolor, pf, sencibilidad, fosteomuscular, postura, marcha, dx_fisioterapeutico, pron_fisioterapeutico, plan_intervencion, obj_terapeutico, estado_fisio_dom,
...
from pacientes a inner join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      inner join val_inifisio_dom k on (k.id_adm_hosp=b.id_adm_hosp)
