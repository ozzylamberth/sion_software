...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'VALORACIÓN INICIAL TERAPEUTICA RESPIRATORIA', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,utf8_encode('leña:'),1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      ...
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Antecedentes Terapeuticos:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      ...
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Auscultacion:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      ...
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'OBJETIVOS, PRONOSTICO Y RECOMENDACIONES',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Objetivo general:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['obj_general']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Objetivos Especificos:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['obj_especifico']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Pronostico terapeutico:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['pronostico']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Recomendaciones - Actividades:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
...
i.descripuedad,
j.nom_eps,
k.id_tr_ce, freg_tr_ce, hreg_tr_ce, motivo_consulta, ant_per_fumador, ant_per_leña, ant_per_ambiental, ant_patologico, ant_quirurgicos, ant_traumatologico, ant_terapeutico, ant_toxicologicos, ant_alergicos, ant_farmacologico, ascultacion, fr, fc, so2, petibucal, distal, toracica, abdominal, amplitud, tintercostal, sis_oxigenoterapia, obs_sisoxigeno, obj_general, obj_especifico, pronostico, recomendaciones, estado_tr_ce ,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join tr_sm k on (k.id_adm_hosp=b.id_adm_hosp)
