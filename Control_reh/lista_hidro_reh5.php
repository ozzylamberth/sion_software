...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'EVO':
				$sql="INSERT INTO evo_hidro_reh (id_adm_hosp, id_user, freg_evohidro_reh, hreg_evohidro_reh, evolucionhidro_reh, estado_evohidro_reh) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evoto"]."','Realizada')";
				$subtitulo="Evolución";
				$subtitulo1="Adicionado";
				$subtitulo2="Hidroterapia";
			break;
			case 'IM':
				$sql="INSERT INTO im_hidro_reh ( id_adm_hosp, id_user, freg_imhidro_reh, hreg_imhidro_reh, objetivo_imhidro_reh, actrealizada_imhidro_reh, logros_imhidro_reh, plant_imhidro_reh, estado_imhidro_reh) VALUES
			...
			break;
			case 'PT':
				$sql="INSERT INTO plantrimestral_hidro_reh( id_adm_hosp, id_user, freg_pthidro_reh, hreg_pthidro_reh, obgen_hidro_reh, obespec1_hidro_reh, obespec2_hidro_reh, obespec3_hidro_reh, estado_pthidro_reh) VALUES
...
if (isset($_GET["mante"])){					///nivel 2
    ...
    where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/evo_hidro_reh5.php';
			$subtitulo='Evolución Diaria  Hidroterapia';
			break;
			case 'IM':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/imhidro_reh5.php';
			$subtitulo='Informe Mensual  Hidroterapia';
			break;
			case 'PT':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/planhidro_reh.php';
			$subtitulo='Plan Trimestral Hidroterapia';
			break;
