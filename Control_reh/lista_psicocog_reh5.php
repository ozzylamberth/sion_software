...
'".$_POST["obs_istactil"]."'	,'Realizada'
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_psicocog_reh (id_adm_hosp, id_user, freg_evopsicocog_reh, hreg_evopsicocog_reh, evolucionpsicocog_reh, estado_evopsicocog_reh) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evoto"]."','Realizada')";
				$subtitulo="Evolución";
				$subtitulo1="Adicionado";
				$subtitulo2="Psicologia Cognitiva";
			break;
			case 'IM':
				$sql="INSERT INTO im_psicocog_reh ( id_adm_hosp, id_user, freg_impsicocog_reh, hreg_impsicocog_reh, objetivo_impsicocog_reh, actrealizada_impsicocog_reh, logros_impsicocog_reh, plant_impsicocog_reh, estado_impsicocog_reh) VALUES
			...
			break;
			case 'PT':
				$sql="INSERT INTO plantrimestral_psicocog_reh( id_adm_hosp, id_user, freg_ptpsicocog_reh, hreg_ptpsicocog_reh, obgen_psicocog_reh, obespec1_psicocog_reh, obespec2_psicocog_reh, obespec3_psicocog_reh, estado_ptpsicocog_reh) VALUES
...
if (isset($_GET["mante"])){					///nivel 2
    ...
    where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/evo_psicocog_reh5.php';
			$subtitulo='Evolución Diaria  Psicologia Cognitiva';
			break;
			case 'IM':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/impsicocog_reh5.php';
			$subtitulo='Informe Mensual  Psicologia Cognitiva';
			break;
			case 'PT':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/planpsicocog_reh.php';
			$subtitulo='Plan Trimestral Psicologia Cognitiva';
			break;
