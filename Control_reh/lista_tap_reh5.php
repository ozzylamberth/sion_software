...
'".$_POST["obs_istactil"]."'	,'Realizada'
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_tap_reh (id_adm_hosp, id_user, freg_evotap_reh, hreg_evotap_reh, evoluciontap_reh, estado_evotap_reh) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evoto"]."','Realizada')";
				$subtitulo="Evolución";
				$subtitulo1="Adicionado";
				$subtitulo2="Terapia Asistida con Perros";
			break;
			case 'IM':
				$sql="INSERT INTO im_tap_reh ( id_adm_hosp, id_user, freg_imtap_reh, hreg_imtap_reh, objetivo_imtap_reh, actrealizada_imtap_reh, logros_imtap_reh, plant_imtap_reh, estado_imtap_reh) VALUES
			...
			break;
			case 'PT':
				$sql="INSERT INTO plantrimestral_tap_reh( id_adm_hosp, id_user, freg_pttap_reh, hreg_pttap_reh, obgen_tap_reh, obespec1_tap_reh, obespec2_tap_reh, obespec3_tap_reh, estado_pttap_reh) VALUES
...
if (isset($_GET["mante"])){					///nivel 2
    ...
    where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/evo_tap_reh5.php';
			$subtitulo='Evolución Diaria  TAP';
			break;
			case 'IM':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/imtap_reh5.php';
			$subtitulo='Informe Mensual  TAP';
			break;
			case 'PT':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/plantap_reh.php';
			$subtitulo='Plan Trimestral TAP';
			break;
...
<table class="table table-bordered">
	...
	$doc=$_REQUEST["doc"];
	$sql="SELECT p.id_paciente,tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,fotopac,a.id_adm_hosp,fingreso_hosp,hingreso_hosp,s.nom_sedes
