...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        $this->Ln();
        $this->Cell(30, 3, 'F-GC- 022', 1, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(30, 3, 'Version:03', 1, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(120, 3, 'Fecha de Emision:2017-05-02', 1, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln(10);
	...
	public function ColoredTable($header,$data,$data1) {
      ...
      $this->cell(35,20,$this->image(utf8_encode($row['firma_user']) , $this->GetX(), $this->GetY(),35,20),0,'J');
      $this->Ln();
...
e.id_im_dem,freg_im_dem fecha_Informe,e.objetivo_im_dem Objetivo,e.actrealizada_im_dem Actividades_realizadas,e.logros_im_dem Logors,e.plant_im_dem	 Plan_tratamiento,servicio,e.estado_im_dem estado,e.id_user usuario,
...
where b.tipo_servicio in ('Demencias','AVD')  and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.estado_im_dem='Realizada' and e.freg_im_dem BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
