...
<script src = "js_p/sha3.js"></script>
		...
		</script><form action="<?php echo PROGRAMA.'?doc='.$doc.'&buscar=Consultar&&opcion=67';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Fonoaudiologia Domiciliarios</h4>
<?php include("consulta_rapidaDOM.php");?>
	...
	<section class="panel-body"> <!--evolucion to-->
			...
			<article class="col-xs-10">
				<label for="">Evolucion Fonoaudiologia:</label>
