<form action="<?php echo PROGRAMA.'?&opcion=53';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Equinoterapia Rehabilitación</h4>
