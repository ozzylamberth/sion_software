...
<form action="<?php echo PROGRAMA.'?doc='.$doc.'&buscar=Consultar&opcion=63';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Terapia Respiratoria Domiciliarios</h4>
<?php include("consulta_rapidaDOM.php");?>
	...
	<section class="panel-body"> <!--evolucion to-->
			...
			<article class="col-xs-10">
				<label for="">Evolucion Terapia Respiratoria:</label>
