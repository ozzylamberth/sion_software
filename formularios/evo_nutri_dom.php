<form action="<?php echo PROGRAMA.'?opcion=105';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Nutrición Servicios Domiciliarios</h4>
<?php include("consulta_rapidaDOM.php");?>
	...
	<section class="panel-body"> <!--evolucion to-->
			...
			<article class="col-xs-10">
				...
				<textarea class="form-control" name="evoto" rows="15" required ></textarea>
			</article>
		</section>
