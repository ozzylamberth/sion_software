<form action="<?php echo PROGRAMA.'?&opcion=76';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Acompañamiento sombra Rehabilitación</h4>
<?php include("consulta_rapidaREH.php");?>
	...
	<section class="panel-body"> <!--evolucion to-->
			...
			<article class="col-xs-10">
				<label for="">Evolucion Acompañamiento Sombra:</label>
