<form action="<?php echo PROGRAMA.'?&opcion=86';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
...
<section class="panel-body"> <!--Anamnesis-->
  <section class="panel-body">
    ...
    <article class="col-xs-3">
      ...
      <input type="hidden" name="tipoatencion" value="Ambulatoria" class="form-control" <?php echo $atributo1;?>>
    </article>
