<form action="<?php echo PROGRAMA.'?&opcion=92';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
    ...
    <section class="panel-body">
      ...
      <article class="col-md-10 col-xs-10">
        ...
        <input type="text" name="nom_generico" class="form-control" id="campoUP" value="<?php echo $fila["nom_generico"];?>" required="" <?php echo $atributo3;?>>
				<input type="hidden" name="id_generico_med" class="form-control" id="campoUP" value="<?php echo $fila["id_generico_ins"];?>" required="" <?php echo $atributo3;?>>
      </article>
    </section>
	</section>
