<form action="<?php echo PROGRAMA.'?&opcion=54';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Terapia Asistida por Perros (TAP) Rehabilitación</h4>
