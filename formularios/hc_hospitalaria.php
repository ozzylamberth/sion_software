...
<section class="panel-body">
  ...
  <div id="tabs-3">
	...
	<div id="tabs-7">
		...
		<article class="col-xs-12 lead">
			<label for="">Definir continuidad:</label>
			<select class="form-control" name="df_conducta" required="">
				<option value=""></option>
				<option value="Activo" class="text-success"><strong>Hospitalizacion</strong></option>
				<option value="svoluntario" class="text-danger"><strong>Salida voluntaria</strong></option>
				<option value="Ambulatorio" class="text-primary"><strong>Manejo ambulatorio</strong></option>
			</select>
		</article>
