<form action="<?php echo PROGRAMA.'?&opcion=111';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	<section class="panel-body">
	  ...
	  ?>
		...
		<article>
			<h4 id="th-estilot">Datos registro de enfermería </h4>
		...
		<section class="panel-body"> <!--Anamnesis-->
				...
				<article class="col-xs-10">
					<label for="">Registro enfermeria:</label>
