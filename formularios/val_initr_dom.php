...
<form action="<?php echo PROGRAMA.'?opcion=63';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<div id="tabs" class="panel panel-default">
		<ul>
			...
			<li><a href="#tabs-2">Antecedentes Personales y generales</a></li>
			<li><a href="#tabs-3">Evaluacion</a></li>
			<li><a href="#tabs-4">Pronostico y objetivos</a></li>
			<li><a href="#tabs-5">Recomendaciones</a></li>
		</ul>
      ...
      <article class="col-xs-10 alert alert-info">
