<?php
  ...
  WHERE b.id_adm_hosp = $adm and tipo_servicio='$servicio'";
  //echo $sql_admision;
        ...
        <section class="collapse" id="datpac">
          <section class="panel-body"><!--section de eps-->
            <article class="col-md-8 text-center">
              ...
              <input type="text" name="nompac" class="form-control text-center" value="<?php echo $fila_admision["nom1"];?> <?php echo $fila_admision["nom2"];?> <?php echo $fila_admision["ape1"];?> <?php echo $fila_admision["ape2"];?>"<?php echo $atributo1;?>/>
            </article>
            ...
            <article class="col-md-2">
              ...
              <input type="text" name="nompac" class="form-control text-center" value="<?php echo $fila_admision["genero"];?>" <?php echo $atributo1;?>/>
            </article>
            <article class="col-md-1">
              <label for="">Rh:</label>
