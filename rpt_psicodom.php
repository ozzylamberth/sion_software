...
e.id_evopsico_dom id, e.freg_evopsico_dom fecha_evo,e.hreg_evopsico_dom hora_evo,e.hfin_evopsico_dom hora_fin,e.evolucionpsico_dom evolucion,e.id_user id_user,
...
where b.tipo_servicio = 'Domiciliarios' and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evopsico_dom BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
