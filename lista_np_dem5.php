...
<section class="panel-heading"><h4>Neuropsicologia INDE Programa Demencias</h4></section>
	...
	if ($tabla=$bd1->sub_tuplas($sql)){
		...
		foreach ($tabla as $fila ) {
			if ($fila['tipo_servicio']=='Demencias') {
				...
				echo'<th class="text-center alert-success"><a href="'.PROGRAMA.'?opcion='.$_REQUEST["opcion"].'&mante=PTGEN&idadmhosp='.$fila["id_adm_hosp"].'"><button type="button" class="btn btn-info sombra_movil" ><span class="fa fa-user"></span></button></a></th>';
			...
			if ($fila['tipo_servicio']=='AVD') {
				...
				echo'<th class="text-center alert-info"><a href="'.PROGRAMA.'?opcion='.$_REQUEST["opcion"].'&mante=PTGEN&idadmhosp='.$fila["id_adm_hosp"].'"><button type="button" class="btn btn-info sombra_movil" ><span class="fa fa-user"></span></button></a></th>';
