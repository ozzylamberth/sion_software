...
class MYPDF extends TCPDF {
	...
	public function ColoredTable($header,$data) {
      ...
      // Title
      $this->Cell(180, 20, 'ORDENES MEDICAS AMBULATORIAS', 1, false, 'R', 0, '', 0, false, 'M', 'M');
      $this->Ln();
      ...
      $this->MultiCell(90, 15,utf8_encode($row['cod_cups']. ' - '.$row['prod']) .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(90, 15,utf8_encode($row['obs']) .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->Ln();
      $this->SetFont('helvetica', '',7);
...
i.descripuedad,
j.nom_eps,
k.id_master_prod,k.fecha_orden, k.servicio, k.tipo_atencion, k.dx, k.tdx, k.estado_orden,
m.id_d_procedimiento,m.cod_cups,m.procedimiento prod,m.observacion obs,m.estado_prod,m.freg_inter,m.nota_inter,
...
where k.id_adm_hosp ='".$_GET["idadmhosp"]."' and k.tipo_atencion='Ambulatoria'";
