...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        $f1=$_GET["f1"];
        $f2=$_GET["f2"];
        $this->multicell(40,0,$this->image('/images/logoP.png', $this->GetX(), $this->GetY(),45,10),0,'J');
        ...
        $this->Ln();
        $this->SetFont('helvetica', 'B', 9);
        $this->Cell(10,6,'ARL:', 1, false, 'C', 0, '', 0, false, 'M', 'M');
...
e.id_evoarl, e.freg_evo_arl fecha_evo,e.hreg_evo_arl hora_evo,e.evolucion_arl evolucion,e.espec_evo_arl tipo_terapia,e.id_user id_user,
...
where b.tipo_servicio = 'ARL' and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evo_arl BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 8 ASC
";
//echo $sql;
$rs = mysql_query($sql);
