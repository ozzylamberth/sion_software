...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			$tam2=$tam1 + $_POST["tds"];
			$tamt=$tam2/3;
			$sql="INSERT INTO hc_psqui_inde (id_adm_hosp, id_user, freg_hchosp, hreg_hchosp, motivo_consulta, enfer_actual, ant_alergicos, ant_patologico,
				 ant_quirurgico, ant_toxicologico, ant_farmaco, ant_gineco, ant_psiquiatrico, ant_hospitalario, ant_traumatologico, ant_familiar, otros_ant,
				  tad, tas, tam, fr, fc, so, peso, talla, temperatura, imc, examen_mental, paraclinico, analisis, finalidad, causa_externa, dxp, tdxp, dx1,
					tdx1, dx2, tdx2, dx3, tdx3, plantratamiento, tipo_atencion, especialidad, estado_hcpsiqui_inde) VALUES
			('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["motivoconsulta"]."',
				'".$_POST["enferactual"]."','".$_POST["antalergico"]."','".$_POST["antpatologico"]."','".$_POST["antquirurgico"]."','".$_POST["anttoxicologicos"]."',
				'".$_POST["antfarmacologico"]."','".$_POST["antgineco"]."','".$_POST["antpsiquiatrico"]."','".$_POST["anthospitalario"]."','".$_POST["anttrauma"]."','".$_POST["antfami"]."','".$_POST["antotros"]."','".$_POST["tad"]."','".$_POST["tas"]."','$tamt','".$_POST["fr"]."','".$_POST["fc"]."','".$_POST["sao2"]."','".$_POST["peso"]."','".$_POST["talla"]."','".$_POST["temperatura"]."','$imc','".$_POST["examen_mental"]."','".$_POST["paraclinicos"]."','".$_POST["analisis"]."','".$_POST["finconsulta"]."','".$_POST["causaexterna"]."','".$_POST["dx"]."','".$_POST["tdx"]."','".$_POST["dx1"]."','".$_POST["tdx1"]."','".$_POST["dx2"]."','".$_POST["tdx2"]."','".$_POST["dx3"]."','".$_POST["tdx3"]."','".$_POST["plant"]."','Demencias','".$_SESSION["AUT"]["especialidad"]."','Realizada')";
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_psiqui_inde (id_adm_hosp, id_user, freg_evo_psiqui, hreg_evo_psiqui, objetivo_psiqui, subjetivo_psiqui, analisis_evo_psiqui,
				plan_tratamiento_psiqui, dxp, tdxp, dx1, tdx1, dx2, tdx2, servicio, estado_evo_psiqui) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["objetivo"]."',
				'".$_POST["subjetivo"]."','".$_POST["analisis"]."','".$_POST["plantratamiento"]."','".$_POST["dx"]."','".$_POST["tdx"]."','".$_POST["dx1"]."',
				'".$_POST["tdx1"]."','".$_POST["dx2"]."','".$_POST["tdx2"]."','Demencias','Realizada')";
				$subtitulo="Evolucion Medica de Psiquiatria";
				$sub1='Demencias';
				$subtitulo1="Adicionado";
			break;
			case 'ADX':
...
if (isset($_GET["mante"])){					///nivel 2
    ...
    $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      ...
      $especialidad='Psiquiatria';
			$form1='FormulariosINDE/val_inipsiqui_inde.php';
			$subtitulo='Valoracion Inicial ';
			break;
			case 'EVO':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
	...
	<table class="table table-responsive">
		...
		if ($tabla=$bd1->sub_tuplas($sql)){
			...
			foreach ($tabla as $fila ) {
				...
				echo'<th class="text-center"><a href="'.PROGRAMA.'?opcion=133&idadmhosp='.$fila["id_adm_hosp"].'&servicio='.$fila["tipo_servicio"].'&doc='.$fila["doc_pac"].'"><button type="button" class="btn btn-success " ><span class="fa fa-flask"></span></button></a></th>';
