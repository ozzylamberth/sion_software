	...
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			switch ($_POST["operacion"]) {
				...
				if ($ant=='') {
					$sql="INSERT INTO val_inifono_dom (id_user, id_adm_hosp, freg_valinifono_dom, hreg_valinifono_dom, m_consulta, enf_actual, exploracion_organos, nivel_semantico,
																						 nivel_sintactico, nivel_pregmatico, desarrollo_linguistico, test_articulacion, funciones_alimentarias, pronostico, objetivo,
																						 plan_tratamiento) VALUES
												('".$_SESSION["AUT"]["id_user"]."','".$_POST["idadmhosp"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["m_consulta"]."','".$_POST["enf_actual"]."',
												 '".$_POST["exploracion_organos"]."','".$_POST["nivel_semantico"]."','".$_POST["nivel_sintactico"]."','".$_POST["nivel_pregmatico"]."','".$_POST["desarrollo_linguistico"]."',
												 '".$_POST["test_articulacion"]."','".$_POST["funciones_alimentarias"]."','".$_POST["pronostico"]."','".$_POST["objetivo"]."','".$_POST["plan_tratamiento"]."') ;";
			...
			case 'EVO':
			$fecha =date('Y-m-d');
			$nuevafecha = strtotime ( '-37 day' , strtotime ( $fecha ) ) ;
			...
			if ($f1 < $f2) {
				...
				$ht=date('H:i',$horat);
			$sql="INSERT INTO evo_fono_dom (id_adm_hosp, id_user,id_d_aut_dom,freg_reg, freg_evofono_dom, hreg_evofono_dom, hreg_regfono_dom, hfin_evofono_dom, evolucionfono_dom, estado_evofono_dom) VALUES
			...
			if ($f1 >= $f2) {
				...
				$horat= strtotime ( '+40 minute' , strtotime ( $horaInicial ) ) ;
				$ht=date('H:i',$horat);
			$sql="INSERT INTO evo_fono_dom ( id_user,freg_reg, freg_evofono_dom, hreg_evofono_dom, hreg_regfono_dom, hfin_evofono_dom, evolucionfono_dom, estado_evofono_dom) VALUES
			('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["fregreg"]."','".$_POST["freg"]."','".$_POST["hregevo"]."','".$_POST["hreg"]."','$ht','".$_POST["evoto"]."','Realizada')";

			$subtitulo="HEYYY, no se pueden realizar evoluciones menores a 3 días de retrazo";
		}
			break;
			case 'EVOP':
			$horaInicial=$_POST["hregevo"];
...
if (isset($_GET["mante"])){					///nivel 2
    ...
    where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date1=date('H:i');
			$doc=$_REQUEST['doc'];
			$form1='formulariosDOM/FONO/val_inifono_dom.php';
...
<section class="panel-default">
	<section class="panel-heading"><h4>Fonoaudiologia Servicios Domiciliarios</h4></section>
				...
				foreach ($tabla as $fila ) {
					...
					echo'<td class="text-left">
								...
								$sql_detalle="SELECT a.id_m_aut_dom, id_adm_hosp, zona_paciente,cdx_presentacion,dx_presentacion,
															...
															WHERE a.id_adm_hosp=$adm and b.estado_d_aut_dom in (1,2) and b.cups='890110'";
								//echo $sql_detalle;
...
=======
												<p>El paciente no tiene servicios autorizados para Fonoaudiologia</p>
>>>>>>> c98191e00a725324adefa822fa28807d84ce3220
=======
												<p>El paciente no tiene servicioss autorizados para Fonoaudiologia</p>
>>>>>>> 6698e446f7988bfb506ad12628c5e32b708257a8
=======
												<p>El paciente no tiene servicios autorizados para fonoaudiologia</p>
>>>>>>> 14dd39f3e1418191aba5b451b50580849f70c74c
											 </th>';
								}
