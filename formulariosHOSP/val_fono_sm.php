				...
				<section class="panel-body"> <!---->
					...
					<section class="collapse" id="anamnesis">
						...
						<article class="col-xs-5">
							...
							<textarea class="form-control" name="tmuscular_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Sensibilidad:</label>
							<textarea class="form-control" name="sencibilidad_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Simetria Facial:</label>
							<textarea class="form-control" name="sfacial_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Labios:</label>
							<textarea class="form-control" name="labios_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Lengua:</label>
							<textarea class="form-control" name="lengua_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Maxilares:</label>
							<textarea class="form-control" name="maxilar_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Paladar:</label>
							<textarea class="form-control" name="paladar_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Sialorrea:</label>
							<textarea class="form-control" name="sialorrea_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Respiración:</label>
							<textarea class="form-control" name="resp_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
						<article class="col-xs-5">
							<label for="">Tipo Oclusión:</label>
							<textarea class="form-control" name="toclusion_i" rows="3" id="comment" required="Este campo es obligatorio"></textarea>
						</article>
					</section>
				</section>
				<section class="panel-body"> <!---->
