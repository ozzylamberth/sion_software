...
$(".addmore").on('click',function(){
    ...
    data +="<td class='col-xs-3'><article class='col-xs-12'><textarea class='form-control' id='countryname_"+i+"' name='countryname[]' rows='3'></textarea></article><article class='col-xs-3 form-group'><input class='form-control' type='hidden' id='country_no_"+i+"' name='country_no[]'/></article><article class='col-xs-3 form-group'><input class='form-control' type='hidden' id='phone_code_"+i+"' name='phone_code[]' readonly='readonly'/></article><article class='col-xs-3 form-group'><input class='form-control' type='hidden' id='country_code_"+i+"' name='country_code[]' readonly='readonly'/></article><article class='col-xs-3 form-group'><input class='form-control' type='hidden' id='idmplan"+i+"' required name='idmplan[]' value='' readonly='readonly'/></article></td><td class='col-xs-2'><input type='number' class='form-control' required name='sesion[]' id='sesion"+i+"' value=''><input class='form-control' type='hidden' required name='estado[]' id='estado"+i+"'  value='solicitado'/></td><td><select class='form-control' id='jornada"+i+"' required name='jornada[]'><option value=''></option><option value='mañana'>Mañana</option><option value='tarde'>Tarde</option></select></td><td class='col-xs-3'><textarea class='form-control' type='text' id='obs_detalle"+i+"'  name='obs_detalle[]' rows='4'/></textarea></td></tr>";
