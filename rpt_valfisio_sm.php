...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'VALORACIÓN INICIAL TERAPEUTICA FISIOTERAPIA', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(32,5, utf8_encode($row['freg_tr_ce'].' | '.$row['hreg_tr_ce']),1,0,'C');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      ...
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Antecedentes Ocupacionales:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['ant_ocupacional']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      ...
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Apoyo Diagnostico:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['apoyo_dx']),1,'L');
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'VALORACION FISIOTERAPEUTICA',1,0,'C',1);
      $this->Ln();
      $this->Cell(180,0,'Dolor:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['ant_toxicologicos']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Piel y fanereas:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['pf']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Sencibilidad:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['sencibilidad']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Funcion osteomuscular:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['fosteomuscular']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Postura:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['postura']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Marcha:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['marcha']),1,'L');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'Patron respiratorio:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      ...
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'Cianosis:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(20,0,'Petibucal:',1,0,'L',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(10,0,$row['petibucal'],1,0,'L',1);
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(20,0,'Distal:',1,0,'L',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(10,0,$row['distal'],1,0,'L',1);
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Expansion toracica:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['toracica']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Expansion abdominal:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['abdominal']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Expansion amplitud:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['amplitud']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(40,0,'Tiraje intercostal:',1,0,'L',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(10,0,$row['tintercostal'],1,0,'L',1);
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(60,0,'Sistema de oxigenoterapia:',1,0,'L',1);
      $this->SetFont('helvetica', '',8);
      $this->Cell(20,0,$row['sis_oxigenoterapia'],1,0,'L',1);
      $this->multiCell(180,0, utf8_encode($row['obs_sisoxigeno']),1,'L');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'OBJETIVO, DIAGNOSTICO, PRONOSTICO Y PLAN DE INTERVENCION',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Diagnostico fisioterapeutico:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['dx_fisioterapeutico']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Pronostico fisioterapeutico:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['pron_fisioterapeutico']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Objetivo fisioterapeutico:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['obj_terapeutico']),1,'L');
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'Plan de intervencion:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', '',8);
      $this->multiCell(180,0, utf8_encode($row['plan_intervencion']),1,'L');
      $this->Ln();
      $this->SetFont('helvetica', '',8);
...
i.descripuedad,
j.nom_eps,
k.id_fisio_ce, freg_fisio_ce, hreg_fisio_ce, motivo_consulta, ant_patologico, ant_traumaticos, ant_toxicologico, ant_quirurgico, ant_farmacologico, ant_ocupacional, ant_familiar, apoyo_dx, dolor, pf, sencibilidad, fosteomuscular, postura, marcha, dx_fisioterapeutico, pron_fisioterapeutico, plan_intervencion, obj_terapeutico, estado_fisio_ce,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join fisio_sm k on (k.id_adm_hosp=b.id_adm_hosp)
