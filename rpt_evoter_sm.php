...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'EVOLUCIONES TERAPÉUTICAS SALUD MENTAL', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('','B',10);
      $this->Cell(180,0, utf8_encode($row['terapia']),1,0,'C',1);
      $this->SetFont('','B',8);
      $this->Ln();
      $this->MultiCell(180,0, utf8_encode($row['fecha'] .' | '.$row['hora']. ' Profesional: ' .$row['nombre']. ' Registro Profesional: ' .$row['rm_profesional']. ' Especialidad: ' .$row['espec_user']),1,0,'L');
      $this->SetFont('','',7);
...
i.descripuedad,
j.nom_eps,
k.id_evotera idter, k.freg_evotera fecha, k.hreg_evotera hora, k.evoluciontera evolucion, k.tterapia terapia, k.estado_evotera estado,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join evo_terapeutica_sm k on (k.id_adm_hosp=b.id_adm_hosp)
