...
<section class="panel-body">
  ...
  <ul>
    ...
    <li><a href="#tabs-3">Analisis</a></li>
		<li><a href="#tabs-4">Analisis</a></li>
		<li><a href="#tabs-5">Impresion Diagnostica</a></li>
		<li><a href="#tabs-6">Plan tratamiento</a></li>
  </ul>
