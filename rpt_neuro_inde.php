...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'HISTORIA CLINICA NEUROLOGIA', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'EXAMEN NEUROLOGICO',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'examen_neuro:',1,0,'L',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 9);
      $this->Cell(180,0,'PARACLINICOS',1,0,'C',1);
      $this->Ln();
      $this->SetFont('helvetica', 'B', 8);
      $this->Cell(180,0,'paraclinico:',1,0,'L',1);;
      $this->Ln();
      $this->SetFont('helvetica', '',8);
...
i.descripuedad,
j.nom_eps,
k.id_hcneuro_inde, freg_hchosp, hreg_hchosp, motivo_consulta, enfer_actual, ant_alergicos, ant_patologico, ant_quirurgico, ant_toxicologico, ant_farmaco, ant_gineco, ant_psiquiatrico, ant_hospitalario, ant_traumatologico, ant_familiar, otros_ant, tad, tas, tam, fr, fc, so, peso, talla, temperatura, imc, examen_neuro, paraclinico, analisis, finalidad, causa_externa, dxp, tdxp, dx1, tdx1, dx2, tdx2, dx3, tdx3, plantratamiento, tipo_atencion,  estado_hcneuro_inde,
...
from pacientes a left join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join hc_neuro_inde k on (k.id_adm_hosp=b.id_adm_hosp)
