...
class MYPDF extends TCPDF {
	...
	public function ColoredTable($header,$data) {
      ...
      $this->cell(35,20,$this->image(utf8_encode($row['firmat']) , $this->GetX(), $this->GetY(),30,20),0,'J');
      $this->Ln();
		}
...
e.id_evoto_dom id, e.freg_evoto_dom fecha_evo,e.hreg_evoto_dom hora_evo,e.hfin_evoto_dom hora_fin,e.evolucionto_dom evolucion,
e.estado_evoto_dom estado,e.id_user id_user,
...
where b.tipo_servicio = 'Domiciliarios' and b.id_adm_hosp ='".$_GET["idadmhosp"]."'
                                        and e.estado_evoto_dom='Realizada'
                                        and e.freg_evoto_dom BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
