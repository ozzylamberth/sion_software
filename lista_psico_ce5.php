...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO psicologia_ce ( id_adm_hosp ,  id_user ,  freg_psico_ce ,  hreg_psico_ce ,  motivo_consulta ,  remitido_por ,  antecedentes ,  examen_mental ,  personal_social ,  area_familiar ,  area_laboral ,  area_emocional ,  observaciones ,  plan_tratamiento ,  estado_psico_ce ) VALUES
				('".$_POST["idadmhosp"]."',
...
'Realizada')";
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_psico_ce ( id_adm_hosp, id_user, freg_evopsico_ce, hreg_evopsico_ce, evolucionpsico_ce, estado_evopsico_ce) VALUES
...
<table class="table table-bordered">
	...
	$doc=$_REQUEST["nom"];
	$sql="SELECT p.id_paciente,tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,fotopac,a.id_adm_hosp,fingreso_hosp,hingreso_hosp,s.nom_sedes FROM pacientes p LEFT JOIN adm_hospitalario a on p.id_paciente=a.id_paciente LEFT JOIN sedes_ips s on a.id_sedes_ips=s.id_sedes_ips  WHERE p.nom1 LIKE '%".$doc."%' and a.estado_adm_hosp='Activo'  and tipo_servicio='Consulta externa REH'";
