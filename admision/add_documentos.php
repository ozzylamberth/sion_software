       ...
       if ($pac!='' && $adm!='') {
        echo'<label for="">Documento:</label>
            <select name="nomdoc" class="form-control" <?php echo atributo3; ?>>
              ...
              <option value="'.$_REQUEST['idadm'].'_Autorizacion EPS">Autorizacion EPS</option>
              <option value="'.$_REQUEST['idadm'].'_Consentimiento Informado">Consentimiento Informado</option>
              <option value="'.$_REQUEST['idadm'].'_Consentimiento Procedimientos">Consentimiento Procedimientos</option>
              <option value="'.$_REQUEST['idadm'].'_Consentimiento Traslado">Consentimiento Traslado</option>
              <option value="'.$_REQUEST['idadm'].'_Epicrisis">Epicrisis</option>
              <option value="'.$_REQUEST['idadm'].'_Pagare">Pagare</option>
            </select>';
       }
       if ($pac!='' && $adm=='') {
         echo'<label for="">Documento:</label>
