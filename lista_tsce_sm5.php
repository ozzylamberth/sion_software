...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO tsce_sm ( id_adm_hosp, id_user, freg_tsce_sm, hreg_tsce_sm,tipo_atencion,h_familiar,estudio_socio,analisis,concepto_ts,recomendaciones,estado_tsce_sm) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["tipoatencion"]."','".$_POST["h_familiar"]."','".$_POST["estudio_socio"]."','".$_POST["analisis"]."','".$_POST["concepto_ts"]."','".$_POST["recomendaciones"]."','Realizada')";
...
if (isset($_GET["mante"])){					///nivel 2
	switch ($_GET["mante"]) {
		...
		where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/val_tsce_sm.php';
			$subtitulo='Valoracion Trabajo Social';
			break;
