...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO nthd_sm (id_adm_hosp, id_user, freg_nutrice_sm,hreg_nutrice_sm,motivonutri,val_nutri,dxnutri,plan_nutri,recomendaciones,estado_nutrice_sm) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["motivonutri"]."','".$_POST["val_nutri"]."','".$_POST["dxnutri"]."','".$_POST["plan_nutri"]."','".$_POST["recomendaciones"]."','Realizada')";
				$subtitulo="Valoracion Hospital dia";
				$subtitulo1="Adicionado";
				$subtitulo2="Nutricion";
			break;
			case 'EVO':
				$sql="INSERT INTO evo_nthd_sm (id_evoto, id_adm_hosp, id_user, freg_evoto, hreg_evoto, evolucion_to, estado_evoto, resp_evoto) VALUES
...
if (isset($_GET["mante"])){					///nivel 2
	switch ($_GET["mante"]) {
		...
		where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/val_nthd_sm.php';
			$subtitulo='Valoracion Nutricion Hospital dia';
			break;
			case 'EVO':
			$sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
			b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
			...
			where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
				...
				$date=date('Y-m-d');
				$date1=date('H:i');
				$form1='formularios/evo_nthd_sm.php';
				$subtitulo='Evolucion Nutricion Hospital Dia';
				break;
...
<section class="panel panel-default">
	<section class="panel-heading"><h3>Hospital Dia Nutrición (Salud Mental)</h3></section>
