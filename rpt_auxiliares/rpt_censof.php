...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'CENSO CLINICA FACATATIVA'.' Impresión:'.$date, 1, false, 'R', 0, '', 0, false, 'M', 'M');
...
$sql="SELECT a.tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,tel_pac,
     ...
     WHERE b.id_sedes_ips in (2) and b.estado_adm_hosp='Activo' and j.id_piso=1  and b.tipo_servicio='Hospitalario'
...
$sql1="SELECT a.tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,tel_pac,
      ...
      FROM adm_hospitalario b inner join pacientes a on (a.id_paciente = b.id_paciente)
                              ...
                              left join piso j on (j.id_piso = i.id_piso )
                              left join eps e on (e.id_eps = b.id_eps )
     WHERE b.id_sedes_ips in (2) and b.estado_adm_hosp='Activo' and j.id_piso=2  and b.tipo_servicio='Hospitalario'
...
$sql2="SELECT a.tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,tel_pac,
      ...
      FROM adm_hospitalario b inner join pacientes a on (a.id_paciente = b.id_paciente)
                              ...
                              left join piso j on (j.id_piso = i.id_piso )
                              left join eps e on (e.id_eps = b.id_eps )
     WHERE b.id_sedes_ips in (2) and b.estado_adm_hosp='Activo' and j.id_piso=3  and b.tipo_servicio='Hospitalario'
...
$sql3="SELECT a.tdoc_pac,doc_pac,nom1,nom2,ape1,ape2,tel_pac,
      ...
      FROM adm_hospitalario b inner join pacientes a on (a.id_paciente = b.id_paciente)
                              ...
                              left join piso j on (j.id_piso = i.id_piso )
                              left join eps e on (e.id_eps = b.id_eps )
     WHERE b.id_sedes_ips in (2) and b.estado_adm_hosp='Activo' and j.id_piso=4  and b.tipo_servicio='Hospitalario'
