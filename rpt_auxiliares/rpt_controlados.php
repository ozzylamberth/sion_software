...
class MYPDF extends TCPDF {
	public function Header() {
        ...
        // Title
        $this->Cell(180, 20, 'FORMULA MEDICA -- CONTROLADOS', 1, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
	...
	public function ColoredTable($header,$data) {
      ...
      $this->Ln();
      $this->SetFont('helvetica', 'B', 7);
      $this->MultiCell(120, 8,utf8_encode($row['obsfmedhosp']) .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(40, 8,'Dosificación' .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(20, 8,$d1.' - '.$d2.' - '.$d3.' - '.$d4 .$txt, 1, 'L', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->Ln();
      $this->SetFont('helvetica', 'B', 7);
      ...
      $this->Ln();
      $this->MultiCell(45, 8,utf8_encode($row['nom_sedes']) .$txt, 1, 'C', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(45, 8,utf8_encode($row['dir_sedes']) .$txt, 1, 'C', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(45, 8,utf8_encode($row['telefono']) .$txt, 1, 'C', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->MultiCell(45, 8,utf8_encode($row['ciudad']) .$txt, 1, 'C', 0, 0, '', '', true, 0, false, true, 80, 'T');
      $this->Ln(10);
...
$sql="SELECT k.nom_eps,
      ...
      FROM pacientes a INNER JOIN adm_hospitalario b on (a.id_paciente=b.id_paciente)
                       ...
                       INNER JOIN m_producto n on (n.id_producto = m.cod_med  and n.estado_propio = 2)
