...
<section class="panel panel-default">
	<section class="panel-heading"><h4>Reporteador Auditoria externa SURA EPS</h4></section>
	<section class="panel-body">
		...
		<table class="table table-bordered table-responsive">
			...
			WHERE a.id_eps in (15,25) and tipo_servicio='$tserv' Group by id_adm_hosp order by a.fingreso_hosp DESC";
