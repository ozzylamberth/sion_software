  ...
  <head>
				...
				<form  method='post' >
                  ...
                  <th class="col-xs-5 text-center info">Fechas</th>
                    ...
                    <article class="col-xs-12  form-group">
                      <input class="form-control" type='hidden' id='country_no_1' name='country_no[]'/> <!--cups-->
                    </article>
                    <article class="col-xs-12  form-group">
                      <input class="form-control" type='hidden' id='phone_code_1' name='phone_code[]'/> <!--CLASIFICACION EN TIPO PROCEDIMIENTO-->
                    </article>
                    <article class="col-xs-12  form-group">
    ...
    <?php
      ...
      while(true) {
          ...
          $valores="('$idm_prod','$country_no','$countryname','$cantidad','$finicio','$ffinal','$aut_externo','$estado','$intervalo'),";

          //////// YA QUE TERMINA CON COMA CADA FILA, SE RESTA CON LA FUNCI�N SUBSTR EN LA ULTIMA FILA /////////////////////
          $valoresQ= substr($valores, 0, -1);

          ///////// QUERY DE INSERCI�N ////////////////////////////
          $sql = "INSERT INTO d_aut_dom (id_m_aut_dom, cups, procedimiento, cantidad, finicio, ffinal, num_aut_externa, estado_d_aut_dom,intervalo)
        VALUES $valoresQ;";
        echo $sql;
