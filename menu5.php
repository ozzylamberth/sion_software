...
$bd1=new subase();
$sql="SELECT m.id_menu,titulo,grupo from aux_perfiles_menus a LEFT JOIN menu m ON a.id_menu=m.id_menu where a.id_perfil=".$_SESSION["AUT"]["id_perfil"]." and m.grupo='Parametrizacion'";
//echo "$sql";
