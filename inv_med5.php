	<h2>Administracion de Genericos (Medicamentos)</h2>
<?php
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'E':
				...
				$sql="UPDATE generico_medicamento SET nom_generico='".$_POST["nom_generico"]."' WHERE id_generico_med=".$id;
			...
			case 'A':
				$f=date('Y-m-d H:m');
				$sql="INSERT INTO generico_medicamento (id_user, fcreacion, nom_generico) VALUES
...
<?php
	...
	<div class="panel-body">
		...
		if (isset($_REQUEST["nom"])){
			$doc=$_REQUEST["nom"];
			$sql="SELECT id_generico_med, nom_generico from generico_medicamento
...
//echo $sql;
					...
					echo'<td class="text-center">'.$fila["id_generico_med"].'</td>';
					echo'<td class="text-center">'.$fila["nom_generico"].'</td>';
					echo'<th class="text-center" ><a href="'.PROGRAMA.'?opcion=94&idgen='.$fila["id_generico_med"].'"><button type="button" class="btn btn-success sombra_movil " ><span class="fa fa-plus"></span></button></a></th>';
					echo "</tr>\n";
				}
			}
		}
			?>
			<tr>
				<th colspan="11" class="text-center"><a href="<?php echo PROGRAMA.'?opcion='.$_REQUEST["opcion"].'&mante=A&idgen='.$_REQUEST["id_generico_med"].''?>" align="center" ><button type="button" class="btn btn-primary" >Generar Generico</button></a></th>
			</tr>
		</table>
