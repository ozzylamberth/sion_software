...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="./medicacionAmbu/css/jquery-ui.min.css">
    <link rel="stylesheet" type="text/css" href="./medicacionAmbu/css/main.css" />

	<script type="text/javascript" src="https://code.jquery.com/jquery-2.1.1.min.js"></script>
	<script type="text/javascript" src="./medicacionAmbu/js/jquery-ui.min.js"></script>
    ...
    <!-- /Footer -->
    <script src="./medicacionAmbu/js/auto.js"></script>
    <?php
